...
/*
	Insert js into the target servelt.
*/
...
public class TransformerAgent implements ClassFileTransformer {
    ...
    private Logger logger = Logger.getLogger("lab.sysu.prototype.apm.instrumentation.TransformerAgent");

    private static String RECORD = new StringBuilder()
            .append("\n{")
            .append("lab.sysu.prototype.apm.instrumentation.TraceMethodInfo cursor = new lab.sysu.prototype.apm.instrumentation.TraceMethodInfo(Thread.currentThread().getStackTrace());" +
                    "lab.sysu.prototype.apm.instrumentation.Trace trace = lab.sysu.prototype.apm.instrumentation.Trace.create(Thread.currentThread().getId(), cursor, System.currentTimeMillis());\n" +
                    "lab.sysu.prototype.apm.instrumentation.TraceStorage.setTrace(Thread.currentThread().getId(), trace);\n")
            .append("}\n").toString();

    private static String JDBC_RECORD = new StringBuilder()
            .append("\n{")
            .append("lab.sysu.prototype.apm.instrumentation.TraceMethodInfo cursor = new lab.sysu.prototype.apm.instrumentation.JDBCTraceMethodInfo(Thread.currentThread().getStackTrace(), $1);" +
                    "lab.sysu.prototype.apm.instrumentation.Trace trace = lab.sysu.prototype.apm.instrumentation.Trace.create(Thread.currentThread().getId(), cursor, System.currentTimeMillis());\n" +
                    "lab.sysu.prototype.apm.instrumentation.TraceStorage.setTrace(Thread.currentThread().getId(), trace);\n")
            .append("}\n").toString();
    ...
    private static String CLEAR = new StringBuilder()
            .append("{")
            .append("lab.sysu.prototype.apm.instrumentation.TraceStorage.clear(Thread.currentThread().getId());\n")
            .append("}")
            .toString();
    ...
    private static String AFTER_SERVICE = new StringBuilder()
            .append("\n{")
            .append("lab.sysu.prototype.apm.instrumentation.TraceStorage.submit(Thread.currentThread().getId(), ((javax.servlet.http.HttpServletRequest)$1).getRequestURI(), ((javax.servlet.http.HttpServletRequest)$1).getQueryString(), $2.getStatus() > 400);\n")
    ...
    private static String AFTER_FILTER = new StringBuilder()
            ...
            .append("lab.sysu.prototype.apm.instrumentation.ChrResponseWrapper responseWrapper = (lab.sysu.prototype.apm.instrumentation.ChrResponseWrapper)$2;")
            .append("try {\n" +
    ...
    private String BEFORE_FILTER = new StringBuilder()
            .append("{")
            .append("lab.sysu.prototype.apm.instrumentation.ChrResponseWrapper responseWrapper = new lab.sysu.prototype.apm.instrumentation.ChrResponseWrapper((javax.servlet.http.HttpServletResponse)$2);")
